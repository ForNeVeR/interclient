...
echo "Making a deliverable interclient.jar"
echo "========================================="
if cp ../../interclient.jar $ROOT/deliverables ;
then : ; else exit 1 ; fi
if cp ../../interclient-core.jar $ROOT/deliverables ;
then : ; else exit 1 ; fi
if cp ../../interclient-res.jar $ROOT/deliverables ;
then : ; else exit 1 ; fi
if cp ../../interclient-utils.jar $ROOT/deliverables ;
then : ; else exit 1 ; fi
...
then
  ...
  echo "Making installable tar file with install.sh"
  echo "==================================================================="
