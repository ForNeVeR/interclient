 ...
 **/
final public class UpdateConflictException extends LockConflictException 
{
  final private static String className__ = "UpdateConflictException";

  // *** InterBase constructor ***
  UpdateConflictException (int errorKeyIndex,int errorCode, int ibSQLCode, String ibErrorMessage)
  {
