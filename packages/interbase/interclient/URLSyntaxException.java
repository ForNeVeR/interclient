 ...
 **/
final public class URLSyntaxException extends InvalidArgumentException 
{
  final private static String className__ = "URLSyntaxException";

  // *** InterClient constructor ****
  URLSyntaxException (ErrorKey errorKey, String url) 
  {
    super (className__, errorKey, url);
  }
}
