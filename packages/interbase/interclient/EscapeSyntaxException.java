 ...
 **/
final public class EscapeSyntaxException extends InvalidArgumentException
{
  final private static String className__ = "EscapeSyntaxException";

  // *** InterClient constructor ****
  EscapeSyntaxException (ErrorKey errorKey, String arg) 
  {
