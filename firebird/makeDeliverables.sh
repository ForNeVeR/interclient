...
echo "Making stock deliverables"
echo "========================================="
if $ROOT/firebird/makeStockDeliverables.sh $1 ;
then : ; else exit 1 ; fi

echo "Making deliverable jar files"
echo "========================================="
if $ROOT/firebird/makeJarDeliverable.sh $1 ;
then : ; else exit 1 ; fi

echo "Making a deliverable docs directory"
echo "================================="
if $ROOT/firebird/makeDocDeliverables.sh $1 $4 ;
then : ; else exit 1 ; fi
...
if [ $IC_PLATFORM = "solaris" -o $IC_PLATFORM = "hpux" \
	-o $IC_PLATFORM = "linux" ]
then
...
if [ $IC_PLATFORM = "solaris" -o $IC_PLATFORM = "hpux" -o \
	$IC_PLATFORM = "linux" ]
then
  ...
  if mv -f InterClient.tar ../product ;
  then : ; else exit 1 ; fi
